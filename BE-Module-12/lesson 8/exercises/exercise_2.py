...
class SocialNetwork:
    ...
    def find_shortest_path(self, start, end):
        ...
        distances[start] = 0
        pq = [(0, start)]  # Priority queue of (distance, user)
        ...
        while pq:
            ...
            for friend in self.users[current_user]:
                distance = current_distance + 1  # Assuming all friendships have equal weight
...
print("Shortest path between users 1 and 3:", shortest_path)